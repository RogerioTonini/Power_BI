# Biblioteca de scripts em Linguagem M

| Arquivo | Objetivo | Parâmetros | URL |
| --- | --- | --- | --- |
| dimHoras.pq | Tabela de horas | - | <https://github.com/RogerioTonini/Power_BI/blob/main/1_Linguagem_M/dimHoras.pq> |
